...
MySQL - 10.1.28-MariaDB : Database - investment_platform_db
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`investment_platform_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `investment_platform_db`;
...
CREATE TABLE `company_member` (
  ...
  `experience` varchar(128) DEFAULT NULL COMMENT '工作经历描述',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15102614 DEFAULT CHARSET=utf8 COMMENT='公司成员';
...
CREATE TABLE `financing_phase` (
  ...
  `updated` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15101993 DEFAULT CHARSET=utf8 COMMENT='融资经历（融资轮次列表）';
...
) ENGINE=InnoDB AUTO_INCREMENT=15122435 DEFAULT CHARSET=utf8;
